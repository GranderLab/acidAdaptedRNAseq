...
#' @name ifelse2
#' @rdname ifelse2
#' @author \href{https://github.com/edwinth/thatssorandom}{Edwin Thoen}
#' @keywords ifelse2
#' @param ... if2 objects followed by one else2 object.
#' @examples
#' #\href{https://www.r-bloggers.com/a-wrapper-around-nested-ifelse/}
#'    {R-bloggers}
#'
#' @export
...
inChecks.if.else <- function(args) {
    ...
    if (substr(args[[length(args)]], 1, 6) == "ifelse"){
        stop(
        "Last argument needs to be an e function.",
        call. = FALSE
        )
    }
}
...
#' @author \href{https://github.com/edwinth/thatssorandom}{Edwin Thoen}
#' @keywords if2
#' @param if_stat The logical expression.
#' @param then The then statment.
#' @examples
#' #\href{https://www.r-bloggers.com/a-wrapper-around-nested-ifelse/}
#'    {R-bloggers}
#'
...
if2 <- function(if_stat, then) {
    if_stat <- expr_text(if_stat)
    then    <- expr_text(then)
...
#' @author \href{https://github.com/edwinth/thatssorandom}{Edwin Thoen}
#' @keywords else2
#' @param else_ret The else return.
#' @examples
#' #\href{https://www.r-bloggers.com/a-wrapper-around-nested-ifelse/}
#'    {R-bloggers}
#'
